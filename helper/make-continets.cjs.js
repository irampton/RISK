// Function to group territories by continent
function groupTerritoriesByContinent(territories) {
    const continents = {};

    territories.forEach(territory => {
        const continentName = territory.continent;

        // If the continent doesn't exist, create it
        ...
        // Add the territory ID to the continent's territories array
        continents[continentName].territories.push(territory.id);
    });

    // Convert continents object into an array of continents
...
const groupedContinents = groupTerritoriesByContinent(territories);
